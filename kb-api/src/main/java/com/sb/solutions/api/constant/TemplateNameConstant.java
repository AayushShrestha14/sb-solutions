package com.sb.solutions.api.constant;

/**
 * @author : Rujan Maharjan on  9/18/2020
 **/
public class TemplateNameConstant {

    public static final String SITE_VISIT = "SiteVisit";
    public static final String FINANCIAL = "Financial";
    public static final String NET_TRADING_ASSETS = "NetTradingAssets";
    public static final String SECURITY = "Security";
    public static final String SHARE_SECURITY = "Share Security";
