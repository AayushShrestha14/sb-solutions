INSERT IGNORE INTO role (id, created_at, last_modified_at, role_name, status, role_type,
                         role_access)
VALUES (1, '2019-04-04 12:52:44', '2019-04-04 12:53:13', 'admin', 1, 1, 2);

-- password = admin1234
INSERT IGNORE INTO users (id, created_at, last_modified_at, account_no, email, name, password,
