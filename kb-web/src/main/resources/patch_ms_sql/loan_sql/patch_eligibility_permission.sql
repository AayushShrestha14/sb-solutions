...
SET @count = (Select count(*)
              from permission
              where id = 18)
SET @countLoanConfig = (Select count(*)
                        from permission
                        where id = 2)
    if
    (@countLoanConfig = 0)
...
SET IDENTITY_INSERT permission ON
INSERT INTO permission (id, permission_name, fa_icon, front_url, orders, status)
VALUES (18, 'Eligibility', 'fa fa-check-square', '/home/admin/eligibility', 62, 1)
SET IDENTITY_INSERT permission Off
...
(6, 'New Requests', '/home/admin/eligibility/new-requests', 'fa fa-flag'),
(7, 'Eligible ', '/home/admin/eligibility/eligible', 'fa fa-check-circle'),
(8, 'Non Eligible', '/home/admin/eligibility/non-eligible', 'fa fa-exclamation-circle')
