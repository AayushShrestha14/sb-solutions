...
VALUES (15, 'Memo', 'fa fa-envelope', null, 62, 1)
...
VALUES (1, 'Under Review', '/home/memo/underReview', 'fa fa-envelope-open'),
       (2, 'Compose', '/home/memo/compose', 'fa fa-edit'),
       (3, 'Memo Type', '/home/memo/type', 'fa fa-bookmark')
