...
DELETE FROM loan_config_template_list WHERE template_list_id NOT IN (1,2,3,5,6,7,8,9,10,11);
DELETE FROM loan_template WHERE id NOT IN (1,2,5,6,7,8,9,10,11);
