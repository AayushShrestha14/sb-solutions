...
public class SampleTemplate {
    ...
    public static String sampleTemplate() {
        ...
        return "<div\n"
            + "    style=\"padding:0;margin:0 auto;width:100%!important;"
            ...
            + "               style=\"background-color:#ffffff;margin:0 auto;max-width:512px;"
            + "width:inherit\"\n"
            + "               width=\"512\">\n"
            + "          <tbody>\n"
            + "          <tr>\n"
            ...
            + "                          This is a sample mail to test your email Configuration."
            + "</p></td>\n"
            + "                      </tr>\n"
            + "                      </tbody>\n"
            + "                    </table>\n"
